...
describe('UserModel', () => {
  ...
  describe('Virtual id', () => {
    it('debería retornar id como string cuando _id es string', () => {
    ...
    it('debería retornar id usando toHexString cuando _id es ObjectId', () => {
    ...
    it('debería retornar id usando toString cuando _id tiene toString', () => {
      const mockId = {
    ...
    it('debería incluir id en toJSON', () => {
      const user = new TestUserModel({
        _id: '12345678',
        email: 'test@example.com',
        passwordHash: 'hash',
    ...
    it('debería incluir id en toObject', () => {
      const user = new TestUserModel({
        _id: '12345678',
        email: 'test@example.com',
        passwordHash: 'hash',
